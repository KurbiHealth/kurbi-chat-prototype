module.exports = function(name,URL){
	...
	responses['welcome'] = {
		message:{
			...
			body:{
				displayName:name,
				text:"Hercules-CHE, We know how confusing it can be to find the answers to health questions. If that's what brought you here, we’d love to help you connect with our members.\n\nChatting with us is completely anonymous because your privacy is very important.\n\nTo get started, simply click \"Let\'s Chat\" button and follow the prompts.",
