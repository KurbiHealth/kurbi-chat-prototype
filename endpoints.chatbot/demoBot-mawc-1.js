module.exports = function(name,URL){
	...
	responses['welcome'] = {
		...
		responses: {
			type:'original.response welcome',
			body:{
				yes:{
					text: "Ok, let's go",
					id: 'begin',
	...
	responses['get symptom'] = {
		...
		responses:{
			type:'original.small free response',
			body:{
	...
	responses['get duration'] = {
		...
		responses:{
			type:'original.response list text',
	...
	responses['you got it'] = {
		...
		responses:{
			type:'original.large free response',
			body:{
				buttonText:"Add Details",
	...
	function textMessage(name,text,qCode,meta){
		var temp = {};
		temp['type'] = 'original.text message';
		temp.body = {};
		temp.qCode = qCode;
		temp.meta = meta;
